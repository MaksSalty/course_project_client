  ...
  return (
    <div className="max-w-[1000px] mx-auto py-10 px-4">
      ...
      <div className="flex gap-10 py-8">
        <div className="w-2/3">
          <div className="text-gray-500 text-xl">{collect.title}</div>
          ...
          <p className="text-gray-500 opacity-60 text-xs pt-3">
            {collect.text}
          </p>
        ...
        <div className="w-1/3 p-3 bg-gray-500 flex flex-col gap-2 rounded">
          <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              ...
              className="flex justify-center rounded bg-gray-400 py-2 px-4 text-white hover:bg-green-500"
            >
              Send
            </button>
          </form>
